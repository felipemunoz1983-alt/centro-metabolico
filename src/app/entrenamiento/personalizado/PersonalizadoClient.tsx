...
export function PersonalizadoClient() {
  ...
  return (
    <div>
      <StickyAgendar href={AGENDA_URL} color={GOLD} />
      <section ref={heroRef} style={{ height: "320vh" }} className="relative">
        <div className="sticky top-0 h-screen min-h-[100svh] overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          <div ref={bgImgRef} className="absolute inset-0" style={{ transformOrigin: "50% 30%", willChange: "transform" }}>
            <Image src={`${BP}/fuerza3.webp`} alt="Entrenamiento Personalizado" fill priority className="object-cover" style={{ objectPosition: "50% 30%" }} sizes="100vw" />
          </div>
          ...
          <div ref={p1Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 1, willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(234,179,8,0.2)", color: GOLD, border: "1px solid rgba(234,179,8,0.4)" }}>Entrenamiento Personalizado</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Un plan hecho<br /><span style={{ color: GOLD }}>solo para ti.</span>
            </h2>
            <p className="mt-6 max-w-[44ch] text-base leading-relaxed md:text-lg" style={{ color: "rgba(255,255,255,0.65)" }}>
              Uno a uno con tu profesor en cada sesión.<br />Tu nivel, tus objetivos, tu ritmo.
            </p>
          </div>
          ...
          <div ref={p2Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(234,179,8,0.2)", color: GOLD, border: "1px solid rgba(234,179,8,0.4)" }}>Uno a uno</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Tu ritmo.<br /><span style={{ color: GOLD }}>Tus objetivos.</span>
            </h2>
            <p className="mt-6 max-w-[44ch] text-base leading-relaxed md:text-lg" style={{ color: "rgba(255,255,255,0.65)" }}>
              Dos sesiones por semana de una hora.<br />Cada movimiento pensado para ti.
            </p>
          </div>
          ...
          <div ref={p3Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(234,179,8,0.2)", color: GOLD, border: "1px solid rgba(234,179,8,0.4)" }}>$200.000 / mes</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Empieza cuando<br /><span style={{ color: GOLD }}>quieras.</span>
            </h2>
            <p className="mt-6 mb-8 max-w-[44ch] text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>
              Plan individual · Evaluación InBody incluida · Horario a convenir.
            </p>
            <motion.a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-10 py-4 text-base font-bold text-black" style={{ backgroundColor: GOLD }} whileHover={{ scale: 1.05, boxShadow: "0 0 48px rgba(234,179,8,0.6)" }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
          ...
          <div ref={hintRef} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none" style={{ opacity: 0.8 }}>
            ...
            <div className="h-7 w-px" style={{ background: `linear-gradient(to bottom, ${GOLD}99, transparent)` }} />
          </div>
        </div>
      </section>
        ...
        <div className="sticky top-0 h-screen min-h-[100svh] flex items-center overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          <div className="relative z-10 flex h-full w-full lg:w-1/2 flex-col justify-center px-6 sm:px-10 md:px-16">
            <div ref={blk1Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-4 text-lg font-bold uppercase tracking-widest" style={{ color: GOLD }}>El programa</p>
              <h3 className="mb-6 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>Entrenamiento<br />uno a uno.</h3>
              <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>Un profesor dedicado solo a ti. Cada sesión diseñada para tus objetivos, tu nivel y tu ritmo, con seguimiento cercano y ajustes constantes clase a clase.</p>
            </div>
            <div ref={blk2Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-4 text-lg font-bold uppercase tracking-widest" style={{ color: GOLD }}>Plan Personalizado</p>
              <h3 className="mb-6 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>Tu plan,<br />a tu medida.</h3>

              <div className="mb-4 flex items-center gap-3 rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(234,179,8,0.10)", border: "1px solid rgba(234,179,8,0.30)" }}>
                <span className="shrink-0 text-base font-bold" style={{ color: GOLD }}>✓</span>
                <p className="text-sm leading-snug" style={{ color: "rgba(255,255,255,0.85)" }}>
                  Incluye evaluación{" "}
                  <img src={`${BP}/inbody-logo.png`} alt="InBody" className="inline-block align-[-0.12em]" style={{ height: "1.05em", width: "auto", filter: "brightness(0) invert(1)" }} /> para medir tu progreso.
                </p>
              </div>

              <div className="relative mb-5 overflow-hidden rounded-2xl px-5 py-5" style={{ background: "linear-gradient(135deg, rgba(234,179,8,0.20), rgba(234,179,8,0.05))", border: "1px solid rgba(234,179,8,0.5)", boxShadow: "0 0 44px rgba(234,179,8,0.18)" }}>
                <div className="flex items-end justify-between gap-3">
                  <div>
                    <p className="text-lg font-bold text-white">Plan mensual</p>
                    <p className="text-sm" style={{ color: "rgba(255,255,255,0.65)" }}>2 días por semana · 1 hora por sesión</p>
                  </div>
                  <div className="shrink-0 text-right">
                    <p className="text-2xl font-extrabold leading-none" style={{ color: GOLD }}>$200.000</p>
                    <p className="mt-1 text-[11px]" style={{ color: "rgba(255,255,255,0.5)" }}>por mes</p>
                  </div>
                </div>
                <div className="mt-3 border-t border-white/10 pt-3 text-sm" style={{ color: "rgba(255,255,255,0.85)" }}>
                  <span className="font-bold" style={{ color: GOLD }}>Horario:</span> a convenir según tu disponibilidad.
                </div>
              </div>

              <a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-8 py-4 text-base font-bold text-black" style={{ backgroundColor: GOLD, boxShadow: "0 0 32px rgba(234,179,8,0.35)" }}>Agendar Entrenamiento Personalizado →</a>
            </div>
          </div>
          <div className="hidden lg:block relative h-full flex-1 overflow-hidden">
            <div ref={imgYRef} className="absolute inset-0" style={{ willChange: "transform" }}>
              <Image src={`${BP}/entrenamiento_funcional2.webp`} alt="Entrenamiento Personalizado" fill className="object-cover" sizes="50vw" />
            </div>
