...
export function HibridoClient() {
  ...
  return (
    <div>
      <StickyAgendar href={AGENDA_URL} color={VIO} />
      <section ref={heroRef} style={{ height: "320vh" }} className="relative">
        <div className="sticky top-0 h-screen min-h-[100svh] overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          ...
          <div ref={p1Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 1, willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(124,58,237,0.2)", color: VIO, border: "1px solid rgba(124,58,237,0.4)" }}>Entrenamiento Híbrido</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Un entrenamiento,<br /><span style={{ color: VIO }}>todo tu cuerpo.</span>
            </h2>
            <p className="mt-6 max-w-[44ch] text-base leading-relaxed md:text-lg" style={{ color: "rgba(255,255,255,0.65)" }}>
              Fuerza y resistencia en la misma sesión,<br />al estilo de las carreras Hyrox.
            </p>
          </div>
          ...
          <div ref={p2Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(124,58,237,0.2)", color: VIO, border: "1px solid rgba(124,58,237,0.4)" }}>Fuerza + Resistencia</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Corre, empuja,<br /><span style={{ color: VIO }}>levanta.</span>
            </h2>
            <p className="mt-6 max-w-[44ch] text-base leading-relaxed md:text-lg" style={{ color: "rgba(255,255,255,0.65)" }}>
              Corres y enfrentas estaciones funcionales: trineo, remo,<br />sandbag y wall balls. Acondicionamiento real y completo.
            </p>
          </div>
          ...
          <div ref={p3Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(124,58,237,0.2)", color: VIO, border: "1px solid rgba(124,58,237,0.4)" }}>Planes desde $50.000</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Entrena para<br /><span style={{ color: VIO }}>la vida real.</span>
            </h2>
            <p className="mt-6 mb-8 max-w-[44ch] text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>
              Grupos reducidos · Profesor en cada sesión · Intensidad ajustada a tu nivel.
            </p>
            <motion.a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-10 py-4 text-base font-bold text-white" style={{ backgroundColor: VIO }} whileHover={{ scale: 1.05, boxShadow: "0 0 48px rgba(124,58,237,0.6)" }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
              Agendar Híbrido →
            </motion.a>
          </div>
          ...
          <div ref={hintRef} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none" style={{ opacity: 0.8 }}>
            ...
            <div className="h-7 w-px" style={{ background: "linear-gradient(to bottom, rgba(124,58,237,0.6), transparent)" }} />
          </div>
        </div>
      </section>
        ...
        <div className="sticky top-0 h-screen min-h-[100svh] flex items-center overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          <div className="relative z-10 flex h-full w-full lg:w-1/2 flex-col justify-center px-6 sm:px-10 md:px-16">
            <div ref={blk1Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-4 text-lg font-bold uppercase tracking-widest" style={{ color: VIO }}>El método</p>
              <h3 className="mb-6 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>Híbrido,<br />de verdad.</h3>
              <p className="text-base leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>Combinamos carrera con estaciones de fuerza funcional en circuitos de alta intensidad. En una sola sesión mejoras tu capacidad aeróbica, tu potencia y tu resistencia a la fatiga — el modelo que hizo de Hyrox el deporte de fitness de mayor crecimiento del mundo, ahora en grupos reducidos y con un profesor que ajusta cada estación a tu nivel.</p>
            </div>
            <div ref={blk3Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-3 text-lg font-bold uppercase tracking-widest" style={{ color: VIO }}>Planes Híbrido</p>
              <h3 className="mb-5 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>Tu mejor versión<br />está más cerca.</h3>
              <div className="mb-4 flex items-center gap-3 rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(124,58,237,0.10)", border: "1px solid rgba(124,58,237,0.30)" }}>
                <span className="shrink-0 text-base font-bold" style={{ color: VIO }}>✓</span>
              ...
              <p className="mb-4 text-sm leading-snug" style={{ color: "rgba(255,255,255,0.7)" }}>
                <span className="font-bold" style={{ color: VIO }}>Horarios:</span> Mar 19:00 · Jue 19:00
              </p>
              <p className="mb-2.5 text-[11px] font-bold uppercase tracking-[0.2em]" style={{ color: "rgba(255,255,255,0.4)" }}>Créditos · 1 = 1 clase · sin límite semanal · úsalos cuando quieras</p>
              <ul className="mb-4 space-y-2.5">
                {[
                  { freq: "4 créditos", clases: "= 4 clases", precio: "$50.000" },
                  { freq: "8 créditos", clases: "= 8 clases", precio: "$70.000" },
                  { freq: "12 créditos", clases: "= 12 clases", precio: "$80.000" },
                ].map(plan => (
                  <li key={plan.clases} className="flex items-baseline justify-between gap-3 border-b border-white/10 pb-2 text-base">
                    <span className="flex items-center gap-3">
                      <span className="shrink-0" style={{ color: VIO }}>✓</span>
                    ...
                    <span className="font-bold" style={{ color: VIO }}>{plan.precio}<span className="ml-0.5 text-xs font-normal" style={{ color: "rgba(255,255,255,0.4)" }}>/mes</span></span>
                  </li>
                ))}
              </ul>

              <div className="relative mb-4 overflow-hidden rounded-2xl px-5 py-4" style={{ background: "linear-gradient(135deg, rgba(124,58,237,0.20), rgba(124,58,237,0.05))", border: "1px solid rgba(124,58,237,0.5)", boxShadow: "0 0 44px rgba(124,58,237,0.20)" }}>
                <span className="mb-2.5 inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-[10px] font-bold uppercase tracking-widest text-white" style={{ backgroundColor: VIO }}>★ Mejor valor</span>
                <div className="flex items-end justify-between gap-3">
                  <div>
                    <p className="text-lg font-bold text-white">Plan Trimestral</p>
                    <p className="text-sm" style={{ color: "rgba(255,255,255,0.65)" }}>36 créditos · 36 clases · 3 meses</p>
                  </div>
                  <div className="shrink-0 text-right">
                    <p className="text-2xl font-extrabold leading-none" style={{ color: VIO }}>$190.000</p>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-white/10 pt-3 text-sm">
                  ...
                  <span className="rounded-md px-2 py-0.5 text-xs font-bold" style={{ backgroundColor: "rgba(124,58,237,0.22)", color: VIO }}>Ahorras $50.000</span>
                </div>
              </div>

              <div className="mb-6 rounded-xl px-4 py-3 text-sm" style={{ backgroundColor: "rgba(124,58,237,0.08)", border: "1px solid rgba(124,58,237,0.25)", color: "rgba(255,255,255,0.85)" }}>
                <span className="font-bold" style={{ color: VIO }}>+ $20.000:</span> 3 sesiones de Recovery de 30 minutos.
              </div>
              <a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-8 py-4 text-base font-bold text-white" style={{ backgroundColor: VIO, boxShadow: "0 0 32px rgba(124,58,237,0.35)" }}>Agendar Híbrido →</a>
            </div>
          </div>
