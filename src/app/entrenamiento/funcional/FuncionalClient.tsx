...
export function FuncionalClient() {
  ...
  useEffect(() => {
    const tick = () => {
      ...
      if (hero) {
        ...
        if (darkRef.current)  darkRef.current.style.opacity  = String(interp(sp, [0,0.15,0.55,1], [0.55,0.45,0.4,0.65]));
        if (vigRef.current)   vigRef.current.style.opacity   = String(interp(sp, [0,0.3,0.6,1], [0.35,0.15,0.25,0.85]));
      ...
      if (desc) {
        ...
        if (imgYRef.current) {
          imgYRef.current.style.transform = `translateY(${interp(dp, [0,1], [80,-80])}px) scale(1.15)`;
        }
      }
  ...
  return (
    <div>
      <StickyAgendar href={AGENDA_URL} color={BRAND} />
      {/* Scroll hero */}
      <section ref={heroRef} style={{ height: "320vh" }} className="relative">
        <div className="sticky top-0 h-screen min-h-[100svh] overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          ...
          <div ref={bgImgRef} className="absolute inset-0" style={{ transformOrigin: "50% 50%", willChange: "transform" }}>
            <Image src={`${BP}/funcional.webp`} alt="Entrenamiento Funcional DINAFIT" fill priority className="object-cover" sizes="100vw" />
          </div>

          <div ref={darkRef} className="absolute inset-0 pointer-events-none bg-black" style={{ opacity: 0.55 }} />
          <div ref={vigRef}  className="absolute inset-0 pointer-events-none" style={{ opacity: 0.35, background: "radial-gradient(ellipse 70% 70% at 50% 50%, transparent 0%, rgba(0,0,0,0.95) 100%)" }} />
          ...
          <div ref={p3Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            ...
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              El cambio<br /><span style={{ color: BRAND }}>empieza hoy.</span>
            </h2>
            ...
            <motion.a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-10 py-4 text-base font-bold text-white" style={{ backgroundColor: BRAND }} whileHover={{ scale: 1.05, boxShadow: "0 0 48px rgba(0,174,239,0.6)" }} transition={{ type: "spring", stiffness: 300, damping: 20 }}>
        ...
        <div className="sticky top-0 h-screen min-h-[100svh] flex items-center overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          ...
          <div className="relative z-10 flex h-full w-full lg:w-1/2 flex-col justify-center px-6 sm:px-10 md:px-16">
            ...
            <div ref={blk2Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-4 text-lg font-bold uppercase tracking-widest" style={{ color: BRAND }}>Planes DINAFIT</p>
              <h3 className="mb-6 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>
                Tu mejor versión<br />empieza aquí.
              </h3>
              <div className="mb-4 flex items-center gap-3 rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(0,174,239,0.10)", border: "1px solid rgba(0,174,239,0.30)" }}>
                <span className="shrink-0 text-base font-bold" style={{ color: BRAND }}>✓</span>
              ...
              <p className="mb-4 text-sm leading-snug" style={{ color: "rgba(255,255,255,0.7)" }}>
                <span className="font-bold" style={{ color: BRAND }}>Horarios:</span> Lun 18:00 y 19:00 · Mar 18:00 · Mié 18:00 y 19:00 · Jue 18:00 · Sáb 11:00
              </p>
              ...
              <div className="relative mb-4 overflow-hidden rounded-2xl px-5 py-4" style={{ background: "linear-gradient(135deg, rgba(0,174,239,0.20), rgba(0,174,239,0.05))", border: "1px solid rgba(0,174,239,0.5)", boxShadow: "0 0 44px rgba(0,174,239,0.20)" }}>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-white/10 pt-3 text-sm">
                  ...
                  <span className="rounded-md px-2 py-0.5 text-xs font-bold" style={{ backgroundColor: "rgba(0,174,239,0.22)", color: BRAND }}>Ahorras $50.000</span>
                </div>
              </div>

              <div className="mb-6 rounded-xl px-4 py-3 text-sm" style={{ backgroundColor: "rgba(0,174,239,0.08)", border: "1px solid rgba(0,174,239,0.25)", color: "rgba(255,255,255,0.85)" }}>
                <span className="font-bold" style={{ color: BRAND }}>+ $20.000:</span> 3 sesiones de Recovery de 30 minutos.
              </div>
              <a href={AGENDA_URL} className="inline-flex items-center gap-2 rounded-2xl px-8 py-4 text-base font-bold text-white" style={{ backgroundColor: BRAND, boxShadow: "0 0 32px rgba(0,174,239,0.35)" }}>
                Agendar Funcional DINAFIT →
              </a>
            </div>
          </div>
          ...
          <div className="hidden lg:block relative h-full flex-1 overflow-hidden">
            <div ref={imgYRef} className="absolute inset-0" style={{ willChange: "transform" }}>
              <Image src={`${BP}/funcional2.webp`} alt="Entrenamiento Funcional DINAFIT" fill className="object-cover" sizes="50vw" />
            </div>
