  ...
  return (
    <div>
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-10"
        ...
        <a href={AGENDA_URL} className="rounded-xl px-4 py-2 text-xs font-bold text-white" style={{ backgroundColor: ROSE }}>Agendar →</a>
      </header>
      ...
      <section ref={heroRef} style={{ height: "320vh" }} className="relative">
        <div className="sticky top-0 h-screen min-h-[100svh] overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          <div ref={bgImgRef} className="absolute inset-0" style={{ transformOrigin: "50% 50%", willChange: "transform" }}>
            <Image src={`${BP}/cm4.webp`} alt="Recovery Activo" fill priority className="object-cover" sizes="100vw" />
          </div>
          ...
          <div ref={p1Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 1, willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(244,63,94,0.2)", color: ROSE, border: "1px solid rgba(244,63,94,0.4)" }}>Recovery Activo</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
              Recupera tu cuerpo<br /><span style={{ color: ROSE }}>al máximo.</span>
            </h2>
            <p className="mt-6 max-w-[44ch] text-base leading-relaxed md:text-lg" style={{ color: "rgba(255,255,255,0.65)" }}>
              Técnicas de recuperación activa con guía profesional.<br />Regenera, descansa y vuelve más fuerte.
            </p>
          </div>
          ...
          <div ref={p2Ref} className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center pointer-events-none" style={{ opacity: 0, transform: "translateY(60px)", willChange: "opacity, transform" }}>
            <span className="mb-5 rounded-full px-4 py-1.5 text-[11px] font-bold tracking-widest uppercase" style={{ backgroundColor: "rgba(244,63,94,0.2)", color: ROSE, border: "1px solid rgba(244,63,94,0.4)" }}>Regeneración profunda</span>
            <h2 className="text-4xl sm:text-5xl leading-[1.0] text-white md:text-7xl lg:text-8xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", textShadow: "0 2px 20px rgba(0,0,0,0.95), 0 4px 40px rgba(0,0,0,0.9)" }}>
          ...
          <div ref={hintRef} className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 pointer-events-none" style={{ opacity: 0.8 }}>
            ...
            <div className="h-7 w-px" style={{ background: `linear-gradient(to bottom, ${ROSE}99, transparent)` }} />
          </div>
        </div>
      </section>
        ...
        <div className="sticky top-0 h-screen min-h-[100svh] flex items-center overflow-hidden bg-[#0A0A0A]" style={{ transform: "translateZ(0)" }}>
          <div className="relative z-10 flex h-full w-full lg:w-1/2 flex-col justify-center px-6 sm:px-10 md:px-16">
            <div ref={blk1Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              <p className="mb-4 text-lg font-bold uppercase tracking-widest" style={{ color: ROSE }}>El método</p>
              <h3 className="mb-6 text-4xl text-white md:text-5xl" style={{ fontFamily: "var(--font-display)", letterSpacing: "0.02em", lineHeight: "1.1" }}>La recuperación<br />es parte del<br />entrenamiento.</h3>
            ...
            <div ref={blk2Ref} className="absolute inset-x-6 sm:inset-x-10 md:inset-x-16" style={{ opacity: 0, willChange: "opacity, transform" }}>
              ...
              <div className="mb-4 flex items-start gap-3 rounded-xl px-4 py-3" style={{ backgroundColor: "rgba(244,63,94,0.10)", border: "1px solid rgba(244,63,94,0.30)" }}>
                <span className="mt-0.5 shrink-0 text-base font-bold" style={{ color: ROSE }}>✓</span>
                <p className="text-sm leading-snug" style={{ color: "rgba(255,255,255,0.85)" }}>
                  <span className="font-bold" style={{ color: ROSE }}>Evaluación InBody incluida.</span> Cada pack de 4 sesiones incluye una evaluación InBody para medir tu progreso — una aprox. cada 4 semanas, en todos los planes.
                </p>
              </div>
                ...
                {[
                  ...
                  <li key={plan.clases} className="flex items-baseline justify-between gap-3 border-b border-white/10 pb-2 text-base">
                    <span className="flex items-center gap-3">
                      <span className="shrink-0" style={{ color: ROSE }}>✓</span>
                    ...
                    <span className="font-bold" style={{ color: ROSE }}>{plan.precio}<span className="ml-0.5 text-xs font-normal" style={{ color: "rgba(255,255,255,0.4)" }}>/mes</span></span>
                  </li>
                ))}
              </ul>
          ...
          <div className="hidden lg:block relative h-full flex-1 overflow-hidden">
            <div ref={imgYRef} className="absolute inset-0" style={{ willChange: "transform" }}>
              <Image src={`${BP}/cm3.webp`} alt="Recovery Activo" fill className="object-cover" sizes="50vw" />
            </div>
